...
bool BplusTreeScanner::satisfy_condition(const char *pkey) {
  ...
  switch(attr_type){
    ...
    case FLOATS:
      ...
      break;
    case CHARS:
      LOG_INFO("bplus satisfy_condition run---");
      s1=pkey;
      s2=value_;
      break;
    default:
    ...
    case EQUAL_TO:
      switch(attr_type){
        ...
        case FLOATS:
          ...
          break;
        case CHARS:
          LOG_INFO("bplus satisfy_condition EQUAL_TO run---");
    ...
    case LESS_THAN:
      switch(attr_type){
        ...
        case FLOATS:
          ...
          break;
        case CHARS:
          LOG_INFO("bplus satisfy_condition LESS_THAN run---");
          flag=(strncmp(s1,s2,attr_length)<0);
          break;
        default:
          LOG_PANIC("Unknown attr type: %d", attr_type);
